...
from core.apps.questions.services.test_sessions import BaseTestSessionService, ORMTestSessionService
import punq
...
def _initialize_container():
    ...
    container.register(BaseTestSessionService, ORMTestSessionService)
    return container
